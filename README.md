...
- [Live Demo Link](https://maleemh.github.io/Leaderboard/dist/)
...
```sh
  git clone https://github.com/MAleemH/Leaderboard.git
  cd Leaderboard
```
...
Feel free to check the [issues page](https://github.com/MAleemH/Leaderboard/issues).
